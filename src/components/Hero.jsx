    ...
    <div className="relative h-[120vh] overflow-hidden bg-slate-900 border-b-8 border-white">
      ...
      <div className="relative z-10 h-screen flex flex-col justify-between px-6 py-12 max-w-[1400px] mx-auto">
        ...
        <div ref={textRef} className="mt-20 flex flex-col items-center sm:items-start text-center sm:text-left mix-blend-overlay text-white/90">
          <h1 className="text-[13vw] sm:text-9xl font-black tracking-tighter leading-[0.85] uppercase opacity-90">
            Engineering <br />
        ...
        {/* Footer Brand Anchor */}
        <div className="w-full border-t border-white/20 pt-8 flex flex-col sm:flex-row justify-between items-center sm:items-end pb-8">
          <div className="flex flex-col gap-1 items-center sm:items-start">
            <span className="text-4xl font-black tracking-tighter uppercase leading-none text-center sm:text-left">Jordan Friesen</span>
            <span className="text-sm tracking-[0.3em] font-medium text-cyan-200 text-center sm:text-left">Front End Developer • Canada</span>
          </div>
